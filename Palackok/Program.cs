...
namespace Palackok
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("egyenlőek e? " + palackok1.egyenloFuggveny(palackok1, palackok2));
            Console.WriteLine("hozzá önt függvény: " + palackok2.hozzaOnt(palackok2, palackok3));
